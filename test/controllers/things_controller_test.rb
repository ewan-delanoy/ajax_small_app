...
class ThingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thing" do
    assert_difference('Thing.count') do
      post things_url, params: { thing: { essence: @thing.essence, substance: @thing.substance } }
    end
  ...
  test "should update thing" do
    patch thing_url(@thing), params: { thing: { essence: @thing.essence, substance: @thing.substance } }
